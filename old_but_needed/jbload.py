...
def noChoice_sam3_e(db_url, criterion):
    df = jbprep.sql2pandas(db_url, 'noChoice_sam3_e', criterion)
    df['experiment'] = 'noChoice_sam3_e'

    # order properly
    SORTORDER = ['condition','counterbalance','workerid', 'trial']
